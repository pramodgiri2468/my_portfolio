  ...
  return (
    <div name="Experiences" className="bg-gradient-to-b from-black to-gray-800 w-full text-white md:h-screen  ">
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="pb--4 ">
            <p className="text-4xl font-bold inline border-b-4 border-gray-500 align-baseline ">Experiences</p>
            <p className="py-5  md:text-xl pb--4  ">Check out some of my Experiences right here</p>
        </div>
